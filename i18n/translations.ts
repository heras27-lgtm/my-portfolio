...
export const translations = (() => {
  const translations = {
    en: {
      ...
      mobileNotice: {
        ...
        message: "To have more details, I recommend viewing my portfolio on a desktop computer!",
        button: "Got it",
      },
      hero: {
        greeting: "Hi, my name is",
        tagline: "Driven by curiosity, powered by data.",
        description: "Passionate about information, I'm looking for opportunities in",
        role: "Data or AI",
        experience: "I bring 1 year of hands-on experience in Data engineering and AI analysis.",
    ...
    fr: {
      ...
      mobileNotice: {
        ...
        message: "Pour avoir plus de détails, je vous recommande de consulter mon portfolio sur un ordinateur !",
        button: "J'ai compris",
      },
      hero: {
        greeting: "Bonjour, je m'appelle",
        tagline: "Guidé par la curiosité, alimenté par la data.",
        description: "Passionné par l'information, je recherche des opportunités en",
        role: "Data ou IA",
        experience: "J'ai plus d'un an d'expérience entre Data Engineering et Intelligence Artificielle.",
        ...
        jobs: [
          {
            ...
            points: [
              ...
              "Contribué au développement d'un assistant IA interne (chatbot) basé sur une architecture RAG, exploitant la documentation Airbus avec AWS S3, AWS Lambda, Unstructured.io et OpenSearch."
            ],
            mobile: [
            ...
            mobileTech: ["Python", "AWS", "RAG", "Analyse de produits"],
            mobileTimeline: "Analyses IA stratégiques & évaluations technologiques pour 1000+ employés. Développé un chatbot basé sur une architecture RAG."
          },
          {
            ...
            mobileTech: ["SQL Server", "ETL", "Power BI", "T-SQL"],
      ...
      projects: {
        ...
        list: [
          {
            title: "Visualisation de données rugby",
            description: "Développé des analyses et visualisations à partir d'un ensemble de données fourni par la Section Paloise.",
          ...
          {
            title: "Analyse de Données Football",
  ...
  // Recompute techCount for each project as tech.length + 1
  Object.values(translations).forEach((lang: any) => {
    if (lang?.projects?.list && Array.isArray(lang.projects.list)) {
      lang.projects.list = lang.projects.list.map((proj: any) => ({
        ...proj,
        techCount: (Array.isArray(proj.tech) ? proj.tech.length : 0),
      }));
    }
  });
